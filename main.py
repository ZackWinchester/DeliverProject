...
lower_yellow_2 = np.array([23, 104, 127])
upper_yellow_2 = np.array([40, 255, 255])
mask = cv2.inRange(hsvFrameConvert_1, lower_yellow_2, upper_yellow_2)
...
finalImgName = "FinalImage.jpg".format()
cv2.imwrite(finalImgName, load_Target2)
ToLoadGray = cv2.imread("FinalImage.jpg")
...
final_image = cv2.imread("FinalImage.jpg")

# Drawing the bounding box
cv2.rectangle(final_image, (lowestx, lowesty), (highestx, highesty), (0, 255, 0), 2)

# Save the image with the bounding box
cv2.imwrite("FinalImage_WithBoundingBox.jpg", final_image)
cv2.imshow('Final Image with Bounding Box', final_image)
...
plt.text(0, 0, (final_ConversionCenterX_1, final_ConversionCenterY_1, '0.000'), fontsize=20,
...
print('\nThe length of the cube based on pixel in the picture is: ', side_cm)
print('The actual length of the cube in cm: 7cm')
